...
const ColorPicker = ({ Selected_Color, onChange }) => {
    const colors = [
    ...
    return (
        <div className='relative'>
            <button onClick={() => setIsOpen(!isOpen)}
                className='flex item-center gap-1 text-sm text-purple-600 bg-gradient-to-br from-purple-50 to-purple-100 ring-purple-300 hover:ring transition-all px-3 py-2 rounded-lg'>
                <Palette className='size-4' /><span className='max-sm:hidden'>Accent</span>
            </button>
            {isOpen && (
