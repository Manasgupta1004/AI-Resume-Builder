import { ZapIcon, Zap } from 'lucide-react';
...
const features = () => {
    ...
    return (
        <div id='#feature' className='flex flex-col items-center scroll-mt-12 '>
            <div className="flex  items-center gap-2 text-sm text-green-600 bg-green-400/10 border rounded-full px-4 py-1">
                <Zap width={14}/>
                <span>Simple Process</span>
            </div>
            <Title title="Built Your Resume" dscr='Our streamlined process helps you create a professional resume in minutes'/>
