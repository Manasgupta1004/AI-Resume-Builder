...
const footer = () => {
    return (
        <>
            <footer className="flex mt-30 flex-wrap  justify-center lg:justify-between overflow-hidden gap-10 md:gap-20
             py-16 px-6 md:px-16 lg:px-24 xl:px-32  text-[13px] text-gray-500 bg-gradient-to-r from-white via-green-200/40 to-white">
                <div className="flex  items-start flex-wrap gap-10 md:gap-[60px] xl:gap-[140px]">
                    <a href="/"> <h1 className='text-5xl font-semibold '>resume<span className='text-green-600'>.</span></h1>
                    </a>
                    <div>
                    ...
                    <div>
                        ...
                        <ul className="mt-2 space-y-2">
                            ...
                            <li><a href="/" className="hover:text-green-600 transition flex">Careers<span className="text-xs text-white bg-green-600 rounded-md ml-2 px-2 py-1">hiring!</span></a></li>
