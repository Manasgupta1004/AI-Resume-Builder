        ...
        <>
            <div className="min-h-screen pb-10">
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <p className="max-w-md text-center text-base my-7">create, edit and download professional resume with <br /> AI-Powered assistance.</p>
                    ...
                    <div className="flex items-center gap-4 ">
                        ...
                        <button className="flex items-center gap-2 border border-green-400 hover:bg-green-50 transition rounded-full px-7 h-12 text-slate-700">
